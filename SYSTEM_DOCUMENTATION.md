...
### 3.3. Cơ Chế Sở Hữu (Collection System)
- Người dùng có thể nhấn "Sở Hữu Ngay" để đưa vật phẩm vào bộ sưu tập cá nhân.
- Hệ thống kiểm tra trạng thái sở hữu theo thời gian thực để cập nhật giao diện nút bấm (Đã sở hữu/Mua ngay).
- Bộ sưu tập cá nhân được quản lý trong một Modal riêng biệt, cho phép xem lại các vật phẩm đã mua.

### 3.4. Giám Định Vật Phẩm (Creation System)
- Tính năng "Thêm mới" cho phép người dùng nhập tên và chọn ngành hàng.
- Hệ thống sẽ đóng vai trò "Giám định viên", tự động cấp độ hiếm, chỉ số và giá trị cho vật phẩm mới dựa trên thuật toán cốt lõi.
